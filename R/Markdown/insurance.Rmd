...
Inizialmente le colonne che compongono il dataset sono 11 più l'ultima che è quella che identifica la classe di appartenenza delle istanze, ovvero la ground truth. Le features sono informazioni di base delle persone prese in esame, in particolare:
